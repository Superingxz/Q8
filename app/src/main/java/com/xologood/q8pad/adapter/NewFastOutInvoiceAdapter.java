...
public class NewFastOutInvoiceAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        NewFastOutInvoiceAdapter.OutInvoiceViewHolder invoiceViewHolder = null;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_fast_out_invoice, parent, false);
            invoiceViewHolder = new NewFastOutInvoiceAdapter.OutInvoiceViewHolder();
            ...
            invoiceViewHolder = (NewFastOutInvoiceAdapter.OutInvoiceViewHolder) convertView.getTag();
        }
