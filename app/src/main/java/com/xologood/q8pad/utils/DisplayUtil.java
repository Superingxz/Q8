...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = Qpadapplication.getAppContext().getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = Qpadapplication.getAppContext().getResources().getDisplayMetrics().scaledDensity;
